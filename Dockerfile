...
WORKDIR /container_project_stuff/foo_project
...
## copies the contents of the current host directory (django_template_42_project) into the container at /container_project_stuff/foo_project
COPY . /container_project_stuff/foo_project/
